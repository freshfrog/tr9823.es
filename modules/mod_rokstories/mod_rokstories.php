...
if (modRokStoriesHelper::checkRequest()) require(JModuleHelper::getLayoutPath('mod_rokstories', 'ajax'));
	...
	else if ($params->get('layout_type') == 'layout7') require(JModuleHelper::getLayoutPath('mod_rokstories', 'layout7'));
	else if ($params->get('layout_type') == 'layout8') require(JModuleHelper::getLayoutPath('mod_rokstories', 'layout8'));
