...
if ($iebrowser && $params->get("load_css", "1") == "1") {
    ...
    if (file_exists($check . ".css")) $document->addStyleSheet($style . ".css"); elseif (file_exists($check . ".php")) $document->addStyleSheet($style . ".php");
}
...
if ($show_accordion) require(JModuleHelper::getLayoutPath('mod_roknewspager', 'accordion')); else require(JModuleHelper::getLayoutPath('mod_roknewspager'));