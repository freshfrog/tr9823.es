            ...
            <div class="roknewspager-div">
                <div class="roknewspager-content">
                    ...
                    <?php if ($show_title && $item->title): ?>
                        ...
                        <?php endif; ?>
                    <?php endif;?>
                    <?php if ($show_preview_text && $item->introtext): ?>
                    <div class="introtext"><?php echo $item->introtext; ?></div><?php endif;?>
                    <?php if ($show_comment_count): ?>
                    <div class="commentcount"><?php echo $item->comment_count; ?></div><?php endif;?>
                    <?php if ($show_author && $item->author): ?>
                    <div class="author"><?php echo $item->author; ?></div><?php endif;?>
                    <?php if ($show_published_date && $item->published_date): ?>
                    <div
                        class="published-date"><?php echo JHTML::_('date', $item->published_date, JText::_('DATE_FORMAT_LC3')); ?></div><?php endif;?>
                    ...
                    <?php endif;?>
                    <?php if ($show_readmore): ?><a href="<?php echo $item->link; ?>"
                                                    class="readon"><span><?php echo $readmore_text;?></span></a><?php endif;?>
                </div>
            </div>
        </div>
        <?php endforeach; ?>
