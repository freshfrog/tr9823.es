...
<?php foreach ($this->items as $i => $item) : ?>
	<li class="row<?php echo $i % 2; ?>">
		...
		<span class="rt-date-posted">
			<span class="rt-date-month rt-date-ribbon"><?php echo JHTML::_('date', $item->created, JText::_('M')) ?></span>
			<span class="rt-date-day rt-date-ribbon"><?php echo JHTML::_('date', $item->created, JText::_('d')) ?></span>
			<span class="rt-date-year rt-date-ribbon"><?php echo JHTML::_('date', $item->created, JText::_('Y')) ?></span>
		</span>
		<?php endif ?>
