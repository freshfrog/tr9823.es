...
class GantryFeatureCompositeOverrides extends GantryFeature {
	...
	function init() {
        ...
        if (defined('ROKCOMMON') && class_exists('RokCommon_Composite')){
            RokCommon_Composite::addPackagePath('mod_rokgallery', JPATH_SITE . '/templates/rt_enigma/overrides/mod_rokgallery/templates',20);
            RokCommon_Composite::addPackagePath('com_rokgallery', JPATH_SITE . '/templates/rt_enigma/overrides/com_rokgallery/templates',20);
        }
	}
