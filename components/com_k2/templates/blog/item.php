...
<div>
	<div class="catItemHeader rt-article date-padding">
		...
		<div class="module-title nomarginbottom">
			...
			<?php endif; ?>
			<h1 class="title" ><?php echo $this->item->title; ?></h1>
		...
		<div class="itemToolbar" style="background: none; border: none; margin: 0">
			<ul style="text-align: left">
				<li>			
					...
					<span class="itemAuthor">
						<em><?php echo JText::_('K2_WRITTEN_BY_MALE'); ?>&nbsp;</em>
		...
		<div class="itemRatingBlock">
			<div class="itemRatingForm">
				...
				<div id="itemRatingLog<?php echo $this->item->id; ?>" class="itemRatingLog">
					<span><?php echo JText::_('RECIPE_VOTES'); ?></span><span><?php echo ($this->item->votingPercentage/100)*5;?></span><?php echo JText::_('RECIPES_TOTAL_OF'); ?>&nbsp;<span style="float: right;"><?php echo $this->item->numOfvotes; ?></span>
				</div>
			</div>
			<div class="clr"></div>
		</div>
