...
<div class="latestItemView rt-article date-padding">
	...
	<?php if($this->item->params->get('latestItemTitle')): ?>
	  <!-- Item title -->
		...
		<div class="module-title"><h2 class="title"><a href="<?php echo $this->item->link; ?>"><?php echo $this->item->title; ?></a></h2></div>

	  	<?php else: ?>
		<div class="module-title"><h2 class="title"><?php echo $this->item->title; ?></h2></div>
	  	<?php endif; ?>
	  <?php endif; ?>
  ...
  <div class="latestItemLinks">
	...
	<span class="text-icon rightarrow"><?php echo JText::_('Mas recetas de este tipo en: '); ?></span><a style="font-weight: normal" href="<?php echo $this->item->category->link; ?>"> <?php echo $this->item->category->name; ?></a>
	...
	<?php if ($this->item->params->get('latestItemReadMore')): ?>
        <!-- Item "read more..." link -->
       <div class="latestItemReadMore"><a class="readon" href="<?php echo $this->item->link; ?>"><span><?php echo JText::_('Leer receta de ');  echo $this->item->title; ?></span></a></div>
        <?php endif; ?>
