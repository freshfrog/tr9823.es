...
<div >
  ...
  <div class="itemToolbar" style="background: none; border: none; margin: 0">
			...
			<li>
				...
				<?php else: ?>
					...
					<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
						<span><?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments>1) ? JText::_('comentarios') : JText::_('comentario'); ?>
					</a>
					<?php else: ?>
					<a class="itemCommentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
						<?php echo JText::_('¡se el primero en comentar!'); ?>
					</a>
					<?php endif; ?>
				<?php endif; ?>
			</li>
		...
		<div style="padding-left: 8px">
			<span><em><?php echo JText::_('receta publicada en:'); ?></em></span>
	...
	<div class="itemRatingBlock">
		<div class="itemRatingForm">
			...
			<span>valoracion general:</span> <span><?php echo ($this->item->votingPercentage/100)*5;?></span><span>en un total de: </span><span><?php echo $this->item->numOfvotes; ?></span>
			</div>
	  ...
	  <!-- Item Image -->
		<span class="itemImage">
		  	<a class="modal" rel="{handler: 'image'}" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
		  		<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" class="rt-image floatleft smallmarginbottom" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" />
		  	</a>
		</span>
  ...
  <!-- Item navigation -->
  <div class="itemTagsBlock">
  	<span class="itemNavigationTitle"><b><?php echo JText::_('K2_MORE_IN_THIS_CATEGORY'); ?></b></span>

		<?php if(isset($this->item->previousLink)): ?>
		<a class="itemPrevious" href="<?php echo $this->item->previousLink; ?>" style="font-weight: normal; padding-right: 30px">
			&laquo; <?php echo $this->item->previousTitle; ?>
		</a>
		<?php endif; ?>
		<?php if(isset($this->item->nextLink)): ?>
		<a class="itemNext" href="<?php echo $this->item->nextLink; ?>" style="font-weight: normal;padding-left: 30px">
...
<?php endif; ?>
  ...
  <!-- Latest items from author -->
	<div class="itemAuthorLatest floatleft" style="padding:20px 0 0 20px">
		...
		<ul class="triangle white">
			...
			<li>
				<a style="font-weight: normal" href="<?php echo $item->link ?>"><?php echo $item->title; ?></a>
			</li>
			<?php endforeach; ?>
		</ul>
		<div class="clr"></div>
  ...
  <!-- Related items by tag -->
	<div class="itemRelated floatright">
        <div class="module-title nomarginbottom">
                <h3 class="title" style="font-size: 170%"><?php echo JText::_('Si te ha gustado esta receta quizás estes interesado en ...'); ?></h3>
        </div>
		<ul class="" style="list-style-type: none">
			<?php foreach($this->relatedItems as $key=>$item): ?>
			<li class="floatleft" style="width: 300px">
				<div class="box1 floatleft"><div class="rt-block"><div class="module-surround"><div class="module-content">
				<?php if($this->item->params->get('itemRelatedTitle', 1)): ?>
				<a style="font-weight: normal" class="itemRelTitle" href="<?php echo $item->link ?>"><?php echo substr(strip_tags($item->title),0,18); ?></a>
				<?php endif; ?>
				...
				<div class="itemRelIntrotext"><?php echo substr(strip_tags($item->introtext),0,50); ?> ...</div>
				<?php endif; ?>
				...
				<div class="itemRelCat"><span class="text-icon rightarrow"><?php echo JText::_("K2_IN"); ?></span> <a style="font-weight: normal" href="<?php echo $item->category->link ?>"><?php echo $item->category->name; ?></a></div>
				<?php endif; ?>
				</div></div></div></div> 
			</li>
			<?php endforeach; ?>
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <a name="itemCommentsAnchor" id="itemCommentsAnchor"></a>
    ...
    <div class="rt-sidebar-surround nomargintop nopaddingtop">
	  ...
	  <!-- Item user comments -->
<div class="module-title">
    <h4 class="title nomargintop" style="font-size: 130%;"><?php echo $this->item->numOfComments; ?> <?php echo ($this->item->numOfComments>1) ? JText::_('Comentarios') : JText::_('Comentario'); ?></h4>
</div>
	  ...
	  <ul class="itemCommentsList">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>" style='list-style-type: none; background: none repeat scroll 0 0 #FFF; border: 1px solid #CCC; padding:10px; margin: 10px 0'>
	    	...
	    	<span class="commentLink" style="float: right">
		    	<a href="<?php echo $this->item->link; ?>#comment<?php echo $comment->id; ?>" name="comment<?php echo $comment->id; ?>" id="comment<?php echo $comment->id; ?>" style="font-weight: none; font-size: 1em;">
		    		<?php echo JText::_('enlace a este comentario'); ?>
		    	</a>
		    </span>
				...
				<span class="commentDate"><em>
		    	<?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC2')); ?></em>
		    </span>
