  ...
  <div class="itemToolbar" style="background: none; border: none; margin: 0">
	...
	<div class="itemRatingBlock">
		<div class="itemRatingForm">
			...
			<span>valoracion general:</span> <span itemprop="rating"><?php echo ($this->item->votingPercentage/100)*5;?></span><span itemprop="count">en un total de: </span><span><?php echo $this->item->numOfvotes; ?></span>
			</div>
