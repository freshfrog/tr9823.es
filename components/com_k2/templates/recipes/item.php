...
<div itemscope itemtype="http://data-vocabulary.org/Recipe">
	<div class="catItemHeader rt-article date-padding">
		...
		<div class="module-title nomarginbottom">
			...
			<?php endif; ?>
			<h1 itemprop="name" class="title" ><?php echo $this->item->title; ?></h1>
			...
			<ul style="text-align: left">
				<li>			
					...
					<span class="itemAuthor">
						...
						<a rel="author" href="<?php echo $this->item->author->link; ?>" itemprop="author"><?php echo $this->item->author->name; ?></a>
					</span>
					<?php endif; ?>
				</li>
				...
				<?php if($this->item->params->get('itemVideoAnchor') && !empty($this->item->video)): ?>
					...
					<li><a class="itemVideoLink k2Anchor"
						href="<?php echo $this->item->link; ?>#itemVideoAnchor"><?php echo JText::_('K2_MEDIA'); ?>
					</a>
					</li>
					<?php endif; ?>
					...
					<li><a class="itemImageGalleryLink k2Anchor"
						href="<?php echo $this->item->link; ?>#itemImageGalleryAnchor"><?php echo JText::_('K2_IMAGE_GALLERY'); ?>
					</a>
					</li>
					<?php endif; ?>
		...
		<div style="padding-left: 8px">
			<span><em><?php echo JText::_('RECIPE_PUBLISHED_ON'); ?></em></span>
			<a style="font-weight:normal" href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a>
		</div>
		<?php endif; ?>
		...
		<div class="itemRatingBlock">
			<div class="itemRatingForm">
				<ul class="itemRatingList nomargintop nomarginbottom">
				...
				<div id="itemRatingLog<?php echo $this->item->id; ?>" class="itemRatingLog" itemprop="review" itemscope itemtype="http://data-vocabulary.org/Review-aggregate">
					<span><?php echo JText::_('RECIPE_VOTES'); ?></span><span itemprop="rating"><?php echo ($this->item->votingPercentage/100)*5;?></span><?php echo JText::_('RECIPES_TOTAL_OF'); ?>&nbsp;<span itemprop="count" style="float: right;"><?php echo $this->item->numOfvotes; ?></span>
				</div>
			</div>
			<div class="clr"></div>
		</div>
	...
	<div class="itemBody">
		...
		<?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
			...
			<div class="floatleft">
				...
				<!-- Image caption -->
					<span class="itemImageCaption" style="text-align:center; float: none"><?php echo $this->item->image_caption; ?></span>
				<?php endif; ?>
			</div>
	
			<?php if($this->item->params->get('itemImageMainCredits') && !empty($this->item->image_credits)): ?>
			<!-- Image credits -->
			<span style="text-align: center; float: none"><?php echo $this->item->image_credits; ?></span>
			<?php endif; ?>
	...
	<div class="itemSocialSharing">
		...
		<!-- Facebook Button -->
		<div class="itemFacebookButton" style="width:260px">
			<div id="fb-root"></div>
	...
	<div class="itemLinks">
		...
		<div class="itemTagsBlock">
			<span><?php echo JText::_('Receta parte de:'); ?> </span>
			<ul class="itemTags">
		...
		<div class="itemAttachmentsBlock">
			...
			<?php foreach ($this->item->attachments as $attachment): ?>
				<li><a
					title="<?php echo K2HelperUtilities::cleanHtml($attachment->titleAttribute); ?>"
					href="<?php echo $attachment->link; ?>"><?php echo $attachment->title; ?>
				</a> <?php if($this->item->params->get('itemAttachmentsCounter')): ?>
		...
		<!-- Item navigation -->
		<div class="itemTagsBlock">
			<span class="itemNavigationTitle"><b><?php echo JText::_('K2_MORE_IN_THIS_CATEGORY'); ?>
			</b> </span>
	
			<?php if(isset($this->item->previousLink)): ?>
			<a class="itemPrevious"
				href="<?php echo $this->item->previousLink; ?>"
				style="font-weight: normal; padding-right: 30px"> &laquo; <?php echo $this->item->previousTitle; ?>
			</a>
			<?php endif; ?>
			<?php if(isset($this->item->nextLink)): ?>
			<a class="itemNext" href="<?php echo $this->item->nextLink; ?>"
				style="font-weight: normal; padding-left: 30px"> <?php echo $this->item->nextTitle; ?>
				&raquo; </a>
				<?php endif; ?>
	...
	<?php if($this->item->params->get('itemAuthorBlock') && empty($this->item->created_by_alias)): ?>
		<div class="rt-sidebar-surround nomargintop nopaddingtop">
			<div id="rt-sidebar-a">
				<div class="box3 shadow1">
					<div class="rt-block">
						<div class="module-surround">
							<div class="module-content">
								<div class="custombox3 shadow1 itemAuthorBlock" style="background: none; border: none">
									<?php if($this->item->params->get('itemAuthorImage') && !empty($this->item->author->avatar)): ?>
									<img class="itemAuthorAvatar"
										src="<?php echo $this->item->author->avatar; ?>"
										alt="<?php echo K2HelperUtilities::cleanHtml($this->item->author->name); ?>" />
										<?php endif; ?>
									<div class="module-title">
										<h4 class="title" style="font-size: 170%"><?php echo $this->item->author->name; ?></h4>
									</div>
	...
	<?php endif; ?>
		...
		<div class="itemAuthorLatest floatleft" style="padding: 20px 0 0 20px">
			<div class="module-title nomarginbottom">
				<h3 class="title" style="font-size: 170%"><?php echo JText::_('Últimos artículos del autor'); ?></h3>
			</div>
			<ul class="triangle white">
			<?php foreach($this->authorLatestItems as $key=>$item): ?>
				<li><a style="font-weight: normal" href="<?php echo $item->link ?>"><?php echo $item->title; ?></a></li>
			<?php endforeach; ?>
			</ul>
			<div class="clr"></div>
		</div>
		...
		<div class="itemRelated floatright">
			<div class="module-title nomarginbottom">
				<h3 class="title" style="font-size: 170%"><?php echo JText::_('RECIPES_LIKE_RECIPES'); ?></h3>
			</div>
			<ul style="list-style-type: none">
			<?php foreach($this->relatedItems as $key=>$item): ?>
				<li class="floatleft" style="width: 300px">
						...
						<div class="rt-block">
							<div class="module-surround">
								<div class="module-content">
									...
									<div class="itemRelAuthor">
										<?php echo JText::_("K2_BY"); ?>
										<a rel="author" href="<?php echo $item->author->link; ?>"><?php echo $item->author->name; ?>
										</a>
									</div>
									<?php endif; ?>

									<?php if($this->item->params->get('itemRelatedImageSize')): ?>
									<img  class="rt-image floatleft smallmarginbottom" style="width:<?php echo $item->imageWidth; ?>px;height:auto;" class="itemRelImg" src="<?php echo $item->image; ?>" alt="<?php K2HelperUtilities::cleanHtml($item->title); ?>" />
									<?php endif; ?>
									...
									<?php if($this->item->params->get('itemRelatedMedia')): ?>
										...
										<div class="itemRelMediaEmbedded">
											<?php echo $item->video; ?>
										</div>
										<?php else: ?>
									...
									<div class="itemRelCat">
										<span class="text-icon rightarrow"><?php echo JText::_("K2_IN"); ?></span><a style="font-weight: normal" href="<?php echo $item->category->link ?>"><?php echo $item->category->name; ?></a>
									</div>
									<?php endif; ?>
								</div>
							</div>
						...
						<div class="module-surround">
							<div class="module-content">
								...
								<?php if($this->item->params->get('commentsFormPosition')=='above' && $this->item->params->get('itemComments') && !JRequest::getInt('print') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2' && K2HelperPermissions::canAddComment($this->item->catid)))): ?>
									...
									<!-- Item user comments -->
									<div class="module-title">
										<h4 class="title nomargintop" style="font-size: 130%;"><?php echo $this->item->numOfComments; ?><?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?></h4>
									</div>

									<ul class="itemCommentsList">
										<?php foreach ($this->item->comments as $key=>$comment): ?>
										<li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>" style='list-style-type: none; background: none repeat scroll 0 0 #FFF; border: 1px solid #CCC; padding: 10px; margin: 10px 0'>

											<span class="commentLink" style="float: right"> 
												<a href="<?php echo $this->item->link; ?>#comment<?php echo $comment->id; ?>" name="comment<?php echo $comment->id; ?>" id="comment<?php echo $comment->id; ?>" style="font-weight: none; font-size: 1em;"> <?php echo JText::_('enlace a este comentario'); ?></a>
											</span> 
											
											<?php if($comment->userImage): ?> 
											<img src="<?php echo $comment->userImage; ?>" style="float: left; margin: 5px; border: 1px solid" alt="<?php echo JFilterOutput::cleanText($comment->userName); ?>" width="<?php echo $this->item->params->get('commenterImgWidth'); ?>" />
											<?php endif; ?>
											 
											<span class="commentDate">
												<em><?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC2')); ?></em> 
											</span>
		...
		<div class="itemBackToTop">
			<a class="k2Anchor" href="<?php echo $this->item->link; ?>#startOfPageId<?php echo JRequest::getInt('id'); ?>"><?php echo JText::_('K2_BACK_TO_TOP'); ?></a>
		</div>
		<?php endif; ?>
