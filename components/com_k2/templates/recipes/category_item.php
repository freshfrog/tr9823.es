...
<div class="catItemView group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?> rt-article date-padding ">
	...
	<div class="catItemHeader">
                    ...
                    <div class="module-title2">
                        <div class="module-title3">
                            ...
                            <?php if ($this->item->params->get('catItemTitleLinked')): ?>
                                <h3 class="title"><a href="<?php echo $this->item->link; ?>"><?php echo $this->item->title; ?></a></h3>   
                            <?php else: ?>
                                <h4 class="title"><?php echo $this->item->title; ?></h4> 
                            <?php endif; ?>
		...
		<span class="item subtext">
			<em><?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?> <b><?php echo $this->item->author->name; ?></b></em>
		</span>
		<?php endif; ?>
  </div>
...
<!-- Aqui lo que me interesa -->
	  ...
	  <div class="catItemImageBlock">
		  <span class="catItemImage">
		    <a href="<?php echo $this->item->link; ?>" title="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>">
		    	<img class="floatright" src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>" style="width:<?php echo $this->item->imageWidth; ?>px; height:auto;" />
		    </a>
		  </span>
	...
	<div class="catItemCommentsLink">
		...
		<?php else: ?>
			...
			<a style="font-weight: normal" href="<?php echo $this->item->link;?>#itemCommentsAnchor">
				<span class="text-icon quote"><?php echo $this->item->numOfComments; ?> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('comentarios'); ?></span>
			</a>
			<?php else: ?>
			<a style="font-weight: normal" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
			<span class="text-icon quote">	<?php echo JText::_('¡Se el primero en comentar!'); ?></span>
			</a>
			<?php endif; ?>
		<?php endif; ?>
	</div>
	...
	<div class="catItemReadMore">
		<a class="readon" href="<?php echo $this->item->link; ?>">
			<span><?php echo JText::_('Leer receta'); ?></span>
		</a>
	</div>
	<?php endif; ?>
