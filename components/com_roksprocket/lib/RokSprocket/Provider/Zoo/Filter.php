...
class RokSprocket_Provider_Zoo_Filter extends RokSprocket_Provider_AbstractJoomlaPlatformFilter
{
	...
	{
		$this->query->select('a.id, a.application_id, a.type, a.name as title, a.alias' . ', a.state as published, a.access, a.created, a.created_by, a.modified, a.elements, a.hits' . ', a.publish_up, a.publish_down');
