...
class RokSprocket_Provider_Joomla_Filter extends RokSprocket_Provider_AbstractJoomlaPlatformFilter
{
	...
	{
		$this->query->select('a.id, a.title, a.alias, a.introtext, a.`fulltext`, a.catid' . ', a.state, a.access, a.created, a.created_by, a.modified, a.featured, a.language, a.hits' . ', a.publish_up, a.publish_down, a.images, a.urls, a.language, a.metakey, a.metadesc, a.metadata')->from('#__content as a');

		$this->query->select('c.title AS category_title');
