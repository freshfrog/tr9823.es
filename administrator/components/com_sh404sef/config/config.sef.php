...
// 3.4.5.1255
// saved at: 2012-05-17 11:58:52
// by: luis (id: 42 )
// domain: http://www.topreviews.es
...
$shLangTranslateList = array("en-GB"=>"2","es-ES"=>"2");
$shLangInsertCodeList = array("en-GB"=>"2","es-ES"=>"2");
$defaultComponentStringList = array("akeeba"=>"","banners"=>"","contact"=>"","content"=>"","finder"=>"","login"=>"","mailto"=>"","newsfeeds"=>"","search"=>"","weblinks"=>"","wrapper"=>"","gantry"=>"","k2"=>"","rokcandy"=>"","rokgallery"=>"","rokmodule"=>"","roksprocket"=>"");
$pageTexts = array("en-GB"=>"Page-%s","es-ES"=>"Page-%s");
