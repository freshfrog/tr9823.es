<?php
 /**
  * @version   $Id: Base.php 48519 2012-02-03 23:18:52Z btowles $
...
abstract class RokCommon_Doctrine_Migration_Base extends Doctrine_Migration_Base
{
   /**
    ...
    {
        parent::renameTable(RokCommon_Doctrine::getPlatformInstance()->setTableName($oldTableName),
                            RokCommon_Doctrine::getPlatformInstance()->setTableName($newTableName));
    }
